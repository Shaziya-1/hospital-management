...
def discharge_patient_view(request, pk):
    ...
    if not patient:
        return HttpResponse("<h3 style='text-align:center;color:red;'>Patient not found.</h3>")
    ...
    assignedDoctorName = assignedDoctor.first_name if assignedDoctor else "Unknown"
...
def download_pdf_view(request, pk):
    ...
    if not dischargeDetails:
        ...
        return HttpResponse("<h3 style='text-align:center;color:red;'>No discharge details found for this patient.</h3>")
...
def patient_dashboard_view(request):
    ...
    mydict = {
        'patient': patient,
        'doctorName': doctor_info['doctorName'],
        'doctorMobile': doctor_info['doctorMobile'],
        'doctorAddress': doctor_info['doctorAddress'],
        'symptoms': patient.symptoms,
        'doctorDepartment': doctor_info['doctorDepartment'],
        'admitDate': patient.admitDate,
    }
